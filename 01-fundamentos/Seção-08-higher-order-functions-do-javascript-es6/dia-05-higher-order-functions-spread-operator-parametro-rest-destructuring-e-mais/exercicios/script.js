...
const toObject = ([nome, marca, ano]) => ({ nome, marca, ano }); // Foi usada a abreviação
console.log(toObject(palio));
// Outros exemplos
// const toObject = ([name, brand, year]) => ({ name, brand, year }); // Foi usada a abreviação
// const toObject = ([name, brand, year]) => ({ nome: name, marca: brand, ano: year });
